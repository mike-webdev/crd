    ...
    <div className="row">
        <div className="container-fluid">
            <div className="row">
                    <Sidebar 
                        tab_list={[
                                    {"title":"Chapter 1", "target":"v-pills-chapter1", "add_class": "", "sub_list":[]},
                                    {"title":"Chapter 2", "target":"v-pills-chapter2", "add_class": "active", "sub_list":[]},
                                    {"title":"Chapter 3", "target":"v-pills-chapter3", "add_class": "", "sub_list":[]},
                                    {"title":"Chapter 4", "target":"v-pills-chapter4", "add_class": "", "sub_list":[]},
                                    {"title":"Chapter 5", "target":"v-pills-chapter5", "add_class": "", "sub_list":[]},
                ...
                <div className="col-sm-10">
                    ...
                    <div className="">
                        <div className="tab-content" id="sidenav-content">
                            <div className="tab-pane fade" id="v-pills-chapter1" role="tabpanel" aria-labelledby="v-pills-chapter1-tab">
                                <CourseWeekDescription tabId="v-pills-chapter1" weekNumber="1" title="Chapter 1. Fluency and Coherence" description="In this chapter, we’re going to discuss ... lorem ipsum dolor sit amet" />
                            </div>

                        <div className="tab-pane fade show active" id="v-pills-chapter2" role="tabpanel" aria-labelledby="v-pills-chapter2-tab">
                            <CourseWeekDescription tabId="v-pills-chapter1" weekNumber="2" title="Chapter 2. Fluency and Coherence" description="In this chapter, we’re going to discuss ... lorem ipsum dolor sit amet" />
                                ...
                                <div className="accordion accordion-flush" id="accordion1">
                                    ...
                                    <AccordionItem 
                                        ...
                                        items={[
                                            ...
                                            {"title":"Introduction: Pause. What are Pauses?", "link":"/ielts", "minutes": "1"},
                        ...
                        <div className="tab-pane fade" id="v-pills-chapter3" role="tabpanel" aria-labelledby="v-pills-chapter3-tab">...</div>
                        <div className="tab-pane fade" id="v-pills-chapter4" role="tabpanel" aria-labelledby="v-pills-chapter4-tab">...</div>
                        <div className="tab-pane fade" id="v-pills-chapter5" role="tabpanel" aria-labelledby="v-pills-chapter5-tab">...</div>
