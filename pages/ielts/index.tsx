...
import Homework from "../../components/functions/progressive/Homework";
import AdditionalResources from "../../components/functions/progressive/AdditionalResources";
        ...
        <div className="container-fluid">
          ...
          <Sidebar 
            tab_list={[
                        ...
                        {"title":"Chapter 2 Conclusion", "target":"none29", "add_class": "","is_finished":"0", 
                        "sub_list":[
                          {"subtitle": "Chapter Test", "subtarget": "tab-chapter-test", "addsub_class":"","is_finished":"0"},
                          {"subtitle": "Additional Resources", "subtarget":"tab-additional-resources", "addsub_class":"","is_finished":"0"}
                        ]
                        },
                    ]}  
              ...
              <div className="">
                ...
                * */}
                ...
                <Tab 
                    ...
                    breadcrumbs={["Chapter 2", "Lesson 1. Pauses"]}
                    is_active="1"
                  >
                    <Video/>
                </Tab>
                ...
                <Tab 
                  ...
                  >
                    ...
                    <div className="row justify-content-between mt-4">
                        ...
                        <button className="btn btn-dark col-sm-3">Next Activity <i className="fas fa-caret-right"></i></button>
                    </div>
                </Tab>
                ...
                <Tab 
                    id="tab-l1-homework" 
                    title="Homework (Deadline: August 9, 2021)"
                    learn_with_teacher_btn="0"
                    breadcrumbs={["Chapter 2", "Lesson 1. Pauses"]}
                  ...
                  >
                    ...
                    <div className="writing_container" style={{display: "none"}}>
                      <HomeworkWritingTest/>
                    </div>
                ...
                <Tab 
                    id="tab-chapter-test" 
                    title="Chapter Test (Deadline: September 2, 2021)"
                    learn_with_teacher_btn="0"
                    breadcrumbs={["Chapter 2", "Chapter 2 Conclusion"]}
                  >
                    <MultipleItems id="multi1">
                        <div className="item">
                          <p><b>Chapter 2 Chapter Test. Part 1: Multiple Choice (Deadline: September 2, 2021)</b></p>
                          <p>Select the proper answer for the items below.</p>
                          <TrueFalse
                            id="t1"
                          ...
                          <TrueFalse
                            ...
                            answer_explanation="Only the overall speaking band will be shown, not the score in each criterion."
                          />
                          <div className="speaking_action_button mt-4">
                            <button type="button" className="btn btn-dark"><i className="fab fa-telegram-plane"></i> Submit Answers</button>
                          </div> 
                        </div>

                        <div className="item">
                          <p><b>Chapter 2 Chapter Test. Part 1: Choice Table (Deadline: September 2, 2021)</b></p>
                          <Identification/>
                          <div className="speaking_action_button mt-4">
                            <button type="button" className="btn btn-dark"><i className="fab fa-telegram-plane"></i> Submit Answers</button>
                          </div> 
                        ...
                        <div className="item">
                          <p><b>Chapter 2 Chapter Test: Sequencing (Deadline: September 2, 2021)</b></p>
                          <Sequencing/>
                          <div className="speaking_action_button mt-4">
                            <button type="button" className="btn btn-dark"><i className="fab fa-telegram-plane"></i> Submit Answers</button>
                          </div> 
                        ...
                        <div className="item">
                          <p><b>Chapter 2 Chapter Test: Speaking Exercise (Deadline: September 2, 2021)</b></p>
                          <ChapterTestSpeaking />
                        </div>
                    </MultipleItems>
                </Tab>
