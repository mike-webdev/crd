...
export default function Video() {
  ...
  return (
    <>
      ...
      <div className="mt-4 text-center border border-dark rounded pt-3">
        {/* <button className="btn btn-dark">Book a Teacher</button> */}
        <p><strong>To proceed:</strong> Click on the images of your available teachers and connect with the teacher you want the most.</p>
      </div>
