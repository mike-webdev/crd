            ...
            <div className="box">
                <div className="row">
                    ...
                    <div className="col-sm-10">
                        <p>
                            <small>These are the list of categories & its related topics, you can choose any of this upon starting the course. Look for stars on the topic list to know what topics student consider to be the best.</small>
                        </p>
